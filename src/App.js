    ...
    isCollapsed = () => {
        ...
        for (let i=0; i<snake.length-3; i++) {
            if ((head.x === snake[i].x) &&(head.y === snake[i].y)) {
                ...
                alert(`Ты проиграл, количество очков: ${snake.length*10}`)
            }
        }
    }
    ...
    render() {
        ...
        return (
            <div className="a">
                <h1> Змейка</h1>
                <ul>
                    <li>Нажмите «пробел», чтобы приостановить игру.</li>
                    <li>Нажмите «клавиши со стрелками», чтобы изменить направление или возобновить.</li>
                </ul>
